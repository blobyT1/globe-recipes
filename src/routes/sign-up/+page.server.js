...
import { AuthError, createSession, registerUser } from '$lib/server/auth-db.js';
...
export const actions = {
	default: async ({ request, cookies }) => {
		...
		try {
			...
			const message = error instanceof AuthError ? error.message : 'Could not create account right now.';
